...
mboxFactory = function(J, i, K) {
    ...
    this.N = typeof document.createElement('div').replaceChild != 'undefined' && (function() {
            return true;
        })() && typeof document.getElementById != 'undefined' && typeof(window.attachEvent || document.addEventListener || window.addEventListener) !=
        'undefined' && typeof encodeURIComponent != 'undefined';
...
mboxFactory.prototype.setVisitorIdParameters = function(l, ib) {
    var imsOrgId = '89E765C453A2E0CF0A490D45@AdobeOrg';
...
if(typeof mboxVersion == 'undefined') {
    ...
    var mboxFactoryDefault = new mboxFactory('renesas.tt.omtrdc.net', 'renesas', 'default');
};
if(mboxGetPageParameter("mboxDebug") != null || mboxFactoryDefault.getCookieManager().getCookie("debug") != null) {
    ...
    document.write('<' + 'scr' + 'ipt language="Javascript1.2" src=' +
        '"//admin16.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=renesas.tt.omtrdc.net' + '&clientCode=renesas"><' + '\/scr' +
        'ipt>');
};
...
mboxScPluginFetcher.prototype.Oc = function(C) {
    var Pc = ["dynamicVariablePrefix", "visitorID", "vmk", "ppu", "charSet", "visitorNamespace", "cookieDomainPeriods", "cookieLifetime", "pageName",
        "currencyCode", "variableProvider", "channel", "server", "pageType", "transactionID", "purchaseID", "campaign", "state", "zip", "events",
        "products", "linkName", "linkType", "resolution", "colorDepth", "javascriptVersion", "javaEnabled", "cookiesEnabled", "browserWidth",
        "browserHeight", "connectionType", "homepage", "pe", "pev1", "pev2", "pev3", "visitorSampling", "visitorSamplingGroup",
        "dynamicAccountSelection", "dynamicAccountList", "dynamicAccountMatch", "trackDownloadLinks", "trackExternalLinks", "trackInlineStats",
        "linkLeaveQueryString", "linkDownloadFileTypes", "linkExternalFilters", "linkInternalFilters", "linkTrackVars", "linkTrackEvents", "linkNames",
        "lnk", "eo"
    ];
...
mboxVizTargetUrl = function(ib) {
    ...
    C.setBasePath('/m2/' + 'renesas' + '/viztarget');
...
function set_mbox_variables(data) {
    ...
    try {
		...
		//add demandbase start
		
		company_name = escape(data['company_name'] || "");
        industry = escape(data['industry'] || "");
        sub_industry = escape(data['sub_industry'] || "");
        account_status = escape(data['account_status'] || "");
        fortune_1000 = escape(data['fortune_1000'] || "");
        forbes_2000 = escape(data['forbes_2000'] || "");
        employee_range = escape(data['employee_range'] || "");
        revenue_range = escape(data['revenue_range'] || "");
        employee_count = escape(data['employee_count'] || "");
        annual_sales = escape(data['annual_sales'] || "");
        phone = escape(data['phone'] || "");
        street_address = escape(data['street_address'] || "");
        city = escape(data['city'] || "");
        state = escape(data['state'] || "");
        country = escape(data['country'] || "");
        web_site = escape(data['web_site'] || "");
        stock_ticker = escape(data['stock_ticker'] || "");
 ...
 document.write('<script src="' + document.location.protocol + '//api.demandbase.com/api/v2/ip.json?key=47c9b85a4fc58f24644e933f3b060d418ae6a6fa&callback=set_mbox_variables"></script>');